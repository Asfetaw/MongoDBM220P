...
def get_movie(id):
    ...
    # TODO: Error Handling
    # If an invalid ID is passed to `get_movie`, it should return None.InvalidId
...
def logout_user(email):
    ...
    try:
        ...
        db.sessions.delete_one(user_session)
        return {"success": True}
    except Exception as e:
        return {"error": e}
...
def get_user_session(email):
    ...
    try:
        ...
        return db.sessions.find_one( user_session)
    except Exception as e:
        return {"error": e}
...
def delete_user(email):
    ...
    try:
        ...
        db.sessions.delete_one({ "user_d": email })
